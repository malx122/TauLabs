...
ALL_BOARDS := coptercontrol pipxtreme revolution revomini osd freedom quanton kfly discoveryf4 flyingf4 flyingf3
...
BU_BOARDS  := $(filter-out revolution revomini osd freedom quanton kfly flyingf4 discoveryf4 flyingf3, $(BU_BOARDS))
